...
function Stack() {
  return (
    <div className="mx-auto w-full max-w-7xl p-4">
      <div className="text-5xl font-extrabold text-center mb-12 bg-gradient-to-r from-orange-600 to-pink-600 p-4 sm:p-6 rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 border border-gray-300 cursor-pointer">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Stack Card */}
        <NavLink to="/Stack1" className="md:col-span-1">
        ...
        {/* Queue Card */}
        <NavLink to="/Stack2" className="md:col-span-1">
        ...
        {/* Priority Queue Card - Full width on medium screens */}
        <NavLink to="/Stack3" className="md:col-span-2 lg:col-span-1">
        ...
        {/* Leetcode Questions Card */}
        <NavLink to="/Stack4" className="lg:col-span-1">
        ...
        <NavLink to="/Stack5" className="lg:col-span-1">
