            ...
            <div className="container mx-auto px-6 md:px-12 lg:px-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <NavLink to="/" className={({ isActive }) => isActive ? "text-orange-400 font-semibold flex items-center" : "flex items-center text-gray-400 hover:text-orange-400 transition duration-300"}>
                                    <span className="mr-2">🏠</span>
                                    Home
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/about" className={({ isActive }) => isActive ? "text-orange-400 font-semibold flex items-center" : "flex items-center text-gray-400 hover:text-orange-400 transition duration-300"}>
                                    <span className="mr-2">📖</span>
                                    About
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/contact" className={({ isActive }) => isActive ? "text-orange-400 font-semibold flex items-center" : "flex items-center text-gray-400 hover:text-orange-400 transition duration-300"}>
                                    <span className="mr-2">📞</span>
                                    Contact
                                </NavLink>
                            </li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="https://github.com/DUSHYANT2026" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-400 hover:text-orange-400 transition duration-300">
                                    <span className="mr-2">🐙</span>
                                    GitHub
                                </a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/in/dushyant-kumar-b8594a251/" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-400 hover:text-orange-400 transition duration-300">
                                    <span className="mr-2">🔗</span>
                                    LinkedIn
                                </a>
                            </li>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {[
                                ...
                                { name: "GeeksForGeeks", link: "https://www.geeksforgeeks.org/explore?page=1&sortBy=submissions" },
                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {[
                            { name: "GFG-DSA", link: "https://www.geeksforgeeks.org/dsa-tutorial-learn-data-structures-and-algorithms/" },
                            { name: "Take-U-Forward", link: "https://takeuforward.org/strivers-a2z-dsa-course/strivers-a2z-dsa-course-sheet-2" },
